...
const page = () => {
  return (
    <div className='bg-black w-full min-h-screen flex items-center justify-center gap-10'>
        <h1 className='text-white font-semibold text-2xl'>About Scribble-to-Image Generation
        </h1>
